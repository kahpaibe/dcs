...
from .spiders.melonbooks_settings import LOG_IMAGES_PATH, get_id_and_image_file_name_from_url
from typing import Callable

from .spiders.melonbooks_spider import ITEM_IMAGE_FOLDER_PATH
class MelonbooksItemImagePipeline(ImagesPipeline):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(ITEM_IMAGE_FOLDER_PATH, download_func, settings, crawler=crawler)
    ...
    def file_path(
        ...
        *,
        ...
        item_id, file_name = get_id_and_image_file_name_from_url(request.url)
        self.counter += 1
        with open(LOG_IMAGES_PATH, "+a", encoding="utf-8") as f:
