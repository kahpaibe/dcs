...
from .utils import file_path_substitution

# ===================================================================
# User settings
# ===================================================================
RESOURCES_FOLDER_PATH = Path(__file__).parent.parent / "Resources" / "MelonbooksSpider"
LOG_SEARCH_PATH = RESOURCES_FOLDER_PATH / "parsed_search_pages.log" # Here will be logged all event search related paths parsed
